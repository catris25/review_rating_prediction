...
file_path = '/home/lia/Documents/the_project/dataset/to_use/movies_tv_reviews_sm.csv'

df = pd.read_csv(file_path)
s = df['asin'].value_counts().sort_values(ascending=False).head(20)

#solution 1
new_df = pd.DataFrame({'asin':s.index}).merge(df, how='left')
print(new_df)

output_file = '/home/lia/Documents/the_project/dataset/to_use/top_20_reviewed.csv'
